...
var ChatConsumer = /** @class */ (function () {
    ...
    ChatConsumer.prototype.setChat = function (msg) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.chatRepository.save({
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.bot.sendMessage(msg.from.id, 'Чат успешно добавлен')];
                    case 2:
                        _a.sent();
    ...
    ], ChatConsumer.prototype, "setChat", null);
    ChatConsumer = __decorate([
